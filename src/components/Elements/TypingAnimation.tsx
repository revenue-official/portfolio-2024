...
const TypingAnimation: React.FC<TypingAnimationProps> = ({
    ...
    }, [text, isDeleting, currentPhraseIndex, initialPhrases, typingSpeed, deletingSpeed, delayAfterTyping, delayAfterDeleting, nonDeletableIndices, fixedText, hasCompleted]);
